                                                        ...
                                                        <div class="container">
                                                            <ul class="megamenu" data-transition="slide" data-animationtime="300">
                                                                <li class="item-vertical  style1">
                                                                    ...
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-6.png')}}" alt="">Hot Deal 2</strong>
                                                                    </span>
                                                                    </a>
                                                                </li>
                                                                <li class="item-vertical  vertical-style2 with-sub-menu hover">
                                                                    ...
                                                                    <a class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-1.png')}}" alt="">Electronics</strong>
                                                                    </span>
                                                                                    ...
                                                                                    <div class="html item-1">
                                                                                        <div class="row">
                                                                                            ...
                                                                                            <div class="img-banner col-lg-5 col-md-5 col-sm-4">
                                                                                                <a href="#"><img src="{{asset('front/assets/image/catalog/demo/menu/img-static-megamenu-h.jpg')}}" alt="banner"></a>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                ...
                                                                <li class="item-vertical  vertical-style3 with-sub-menu hover">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-2.png')}}" alt="">Travel &amp; Vacation</strong>
                                                                    </span>
                                                                    <b class='fa fa-caret-right'></b>
                                                                    </a>
                                                                                ...
                                                                                <div class="col-sm-7">
                                                                                    <div class="html ">
                                                                                        <div class="row img-banner">
                                                                                            <a href="#"><img src="{{asset('front/assets/image/catalog/demo/menu/ver-img-1.jpg')}}" alt="banner"></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                ...
                                                                <li class="item-vertical ">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-3.png')}}" alt="">Book Stationery</strong>
                                                                    </span>
                                                                    </a>
                                                                </li>
                                                                <li class="item-vertical   item-style3 with-sub-menu hover">
                                                                    ...
                                                                    <a class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-4.png')}}" alt="">Fashion</strong>
                                                                    </span>
                                                                    <b class='fa fa-caret-right'></b>
                                                                    </a>
                                                                            ...
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <div class="link banner-full">
                                                                                        <img src="{{asset('front/assets/image/catalog/demo/menu/menu_bg2.jpg')}}" alt="" style="width: 100%;">
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <li class="item-vertical ">
                                                                    ...
                                                                    <a class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-5.png')}}" alt="">Sport &amp; Entertaiment</strong>
                                                                    </span>
                                                                    </a>
                                                                </li>
                                                                <li class="item-vertical  css-menu with-sub-menu hover">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-8.png')}}" alt="">Spa &amp; Massage</strong>
                                                                    </span>
                                                                    <b class='fa fa-caret-right'></b>
                                                                    </a>
                                                                ...
                                                                <li class="item-vertical ">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-9.png')}}" alt="">Real House</strong>
                                                                    </span>
                                                                    </a>
                                                                </li>
                                                                <li class="item-vertical ">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-6.png')}}" alt="">Mom &amp; Baby</strong>
                                                                    </span>
                                                                    </a>
                                                                </li>
                                                                <li class="item-vertical ">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-7.png')}}" alt="">Food &amp; Restaurant</strong>
                                                                    </span>
                                                                    </a>
                                                                </li>
                                                                <li class="item-vertical ">
                                                                    ...
                                                                    <a href="#" class="clearfix">
                                                                    <span>
                                                                    <strong><i class="icon"></i><img src="{{asset('front/assets/image/catalog/demo/menu/icon/icon-9.png')}}" alt="">Jewelry &amp; Watches</strong>
                                                                    </span>
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    ...
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/fashion/5-60x60.png')}}" alt="Pariatur beef desktop publishing packages monst">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                                </div>
                                                            ...
                                                            <div class="right-block">
                                                                <div class="caption">
                                                                    ...
                                                                    <div  class="content_price price font-ct">
                                                                        <span class="old-price product-price">Rs. 45.00 </span>&nbsp;&nbsp;
                                                                        <span class="price-old">Rs. 50.00 </span>&nbsp;
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    ...
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/fashion/15-60x60.png')}}" alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                                </div>
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    ...
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/fashion/21-60x60.png')}}" alt="Maciti Aliqua occur that pleasures have a lotem">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                                </div>
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    <a class="lt-image" 
                                                                        href="product.html" target="_blank"
                                                                        title="Est Officia Including Shoes Beautiful Pi..">
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/fashion/24-60x60.png')}}" alt="Est Officia Including Shoes Beautiful Pieces Canaz">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                                </div>
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    ...
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/fashion/14-60x60.png')}}" alt="Ligula tortoram ut labore et dolore magna elip">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                                </div>
                                                        ...
                                                        <div class="product-item-container">
                                                            <div class="left-block ">
                                                                <div class="product-image-container so-quickview">
                                                                    ...
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/fashion/10-60x60.jpg')}}" alt="Amazing Yoga Sport Poses Most  People Wouldn't Dream ">
                                                                    </a>
                                                                </div>
                                                                <div class="box-label">
                                                                </div>
                                                            ...
                                                            <div class="right-block">
                                                                <div class="caption">
                                                                    ...
                                                                    <div  class="content_price price font-ct">
                                                                        <span class="old-price product-price">Rs. 89.00 </span>&nbsp;&nbsp;
                                                                        <span class="price-old">Rs. 100.00 </span>&nbsp;
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="transition product-layout">
                                                        <div class="product-item-container ">
                                                            <div class="left-block so-quickview">
                                                                ...
                                                                <div class="product-image-container">
                                                                    <a href="product.html" target="_self">
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/electronic/11.jpg')}}" alt="Charger  Compact Portable with Premium" class="img-responsive">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="right-block">
                                                    ...
                                                    <div class="transition product-layout">
                                                        <div class="product-item-container ">
                                                            <div class="left-block so-quickview">
                                                                ...
                                                                <div class="product-image-container">
                                                                    <a href="product.html" target="_self">
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/electronic/26.jpg')}}" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium" class="img-responsive">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="right-block">
                                                    ...
                                                    <div class="transition product-layout">
                                                        <div class="product-item-container ">
                                                            <div class="left-block so-quickview">
                                                                ...
                                                                <div class="product-image-container">
                                                                    <a href="product.html" target="_self">
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/electronic/6.jpg')}}" alt="Mammo Diablo except to obtain some advan from" class="img-responsive">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="right-block">
                                                    ...
                                                    <div class="transition product-layout">
                                                        <div class="product-item-container ">
                                                            <div class="left-block so-quickview">
                                                                ...
                                                                <div class="product-image-container">
                                                                    <a href="product.html" target="_self">
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/electronic/29.jpg')}}" alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)" class="img-responsive">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="right-block">
                                                                <div class="caption">
                                                                    ...
                                                                    <div class="price">
                                                                        <span class="price-new">Rs. 89.00</span>
                                                                        <span class="price-old">Rs. 100.00</span>
                                                                    </div>
                                                                </div>
                                                                <div class="button-group2">
                                                    ...
                                                    <div class="transition product-layout">
                                                        <div class="product-item-container ">
                                                            <div class="left-block so-quickview">
                                                                ...
                                                                <div class="product-image-container">
                                                                    <a href="product.html" target="_self">
                                                                    <img src="{{asset('front/assets/image/catalog/demo/product/electronic/19.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium" class="img-responsive">
                                                                    </a>
                                                                </div>
                                                            </div>
                                                            <div class="right-block">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col_stzj block">
                                <div class="cate-html">
                                    <ul class="cate-html-item contentslider" data-rtl="no" data-loop="no" data-autoplay="yes" data-autoheight="no" data-autowidth="no" data-delay="4" data-speed="0.6" data-margin="27" data-items_column0="5" data-items_column1="3" data-items_column2="3" data-items_column3="3" data-items_column4="2" data-arrows="yes" data-pagination="no" data-lazyload="yes" data-hoverpause="yes">
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('front/assets/image/catalog/demo/banners/home3/cate-1.jpg')}}" alt="Static Image"></a></div>
                                            <div class="item-content">
                                            <h4><a href="#">Food & Restaurant</a></h4>
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('front/assets/image/catalog/demo/banners/home3/cate-2.jpg')}}" alt="Static Image"></a></div>
                                            <div class="item-content">
                                            <h4><a href="#">SPA & Massage</a></h4>
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('front/assets/image/catalog/demo/banners/home3/cate-3.jpg')}}" alt="Static Image"></a></div>
                                            <div class="item-content" >
                                            <h4><a href="#">Health Care</a></h4>
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('front/assets/image/catalog/demo/banners/home3/cate-4.jpg')}}" alt="Static Image"></a></div>
                                            <div class="item-content">
                                            <h4><a href="#">Fashion</a></h4>
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('front/assets/image/catalog/demo/banners/home3/cate-5.jpg')}}" alt="Static Image"></a></div>
                                            <div class="item-content">
                                            <h4><a href="#">Health Care</a></h4>
                                            </div>
                                        </li>
                                        <li class="item">
                                            <div class="item-image"><a title="Static Image" href="#"><img src="{{asset('front/assets/image/catalog/demo/banners/home3/cate-6.jpg')}}" alt="Static Image"></a></div>
                                            <div class="item-content">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container">
                                                                    <div class="image so-quickview">
                                                                        ...
                                                                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/1-226x226.jpg')}}" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container">
                                                                    <div class="image so-quickview">
                                                                        ...
                                                                        <a class="lt-image" href="product.html" target="_self">
                                                                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/11-226x226.jpg')}}" alt="Charger  Compact Portable with Premium" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container">
                                                                    <div class="image so-quickview">
                                                                        ...
                                                                        <a class="lt-image" href="product.html" target="_self">
                                                                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/26-226x226.jpg')}}" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container">
                                                                    <div class="image so-quickview">
                                                                        ...
                                                                        <a class="lt-image" href="product.html" target="_self">
                                                                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/6-226x226.jpg')}}" alt="Mammo Diablo except to obtain some advan from" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container">
                                                                    <div class="image so-quickview">
                                                                        ...
                                                                        <a class="lt-image" href="product.html" target="_self">
                                                                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/29-226x226.jpg')}}" alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="box-label">
                                                            ...
                                                            <div class="left-block ">
                                                                <div class="product-image-container">
                                                                    <div class="image so-quickview">
                                                                        ...
                                                                        <a class="lt-image" href="product.html" target="_self">
                                                                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/19-226x226.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium" class="img-responsive">
                                                                        </a>
                                                                    </div>
                                                                </div>
                                                                <div class="box-label">
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/25-234x234.jpg')}}" alt="Toshiba Pro 21&quot;(21:9) FHD  IPS LED 1920X1080 HDMI(2)">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-82% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Compact Portable Charger (Power Bank) with Premium">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/19-234x234.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-70% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Portable  Compact Charger (External Battery) t45">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/4-234x234.jpg')}}" alt="Portable  Compact Charger (External Battery) t45">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-40% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/1-234x234.jpg')}}" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-20% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Charger  Compact Portable with Premium">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/11-234x234.jpg')}}" alt="Charger  Compact Portable with Premium">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-20% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Compact Portable Charger (External Battery)">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/13-234x234.jpg')}}" alt="Compact Portable Charger (External Battery)">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                        </div>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Compact Portable Charger (External Battery) T22">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/21-234x234.jpg')}}" alt="Compact Portable Charger (External Battery) T22">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-20% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/26-234x234.jpg')}}" alt="Lorem Ipsum dolor at vero eos et iusto odi  with Premium">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-20% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Mammo Diablo except to obtain some advan from">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/6-234x234.jpg')}}" alt="Mammo Diablo except to obtain some advan from">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-20% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/29-234x234.jpg')}}" alt="Seneo PA046 Fast Charger  Wireless Sleep-Friendly)">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                            <span class="label-product label-sale">-11% </span>
                                                    ...
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            <a class="lt-image" 
                                                                href="product.html" target="_self"
                                                                title="Compact Portable Charger (External Battery) T21">
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/14-234x234.jpg')}}" alt="Compact Portable Charger (External Battery) T21">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                        </div>
                                                ...
                                                <div class="product-item-container">
                                                    <div class="left-block ">
                                                        <div class="product-image-container so-quickview">
                                                            ...
                                                            <img src="{{asset('front/assets/image/catalog/demo/product/electronic/20-234x234.jpg')}}" alt="True Wireless Stereo Bluetooth 4.2 Headphones">
                                                            </a>
                                                        </div>
                                                        <div class="box-label">
                                                        </div>
