<div>
	...
	<div class="container product-detail">
									...
									<div class="so-filter-content-opts-container">
										<div class="so-filter-option opt-select  opt_enable" data-type="manufacturer" data-manufacturer_value="8" data-count_product="4" data-list_product="30,58,61,105">
											<div class="so-option-container">
												...
												<label><img src="#" style="width: 20px; height: 20px;"> Apple</label>
												<div class="option-count ">
													<span>4</span>
													<i class="fa fa-times"></i>
												</div>
										...
										<div class="so-filter-option opt-select  opt_enable" data-type="manufacturer" data-manufacturer_value="10" data-count_product="1" data-list_product="68">
											<div class="so-option-container">
												...
												<label><img src="#" style="width: 20px; height: 20px;"> Sony</label>
												<div class="option-count ">
													<span>1</span>
													<i class="fa fa-times"></i>
												</div>
        ...
        <div class="module banners-effect-9 form-group">
          <div class="banners">
            <div>
              <a href="#"><img src="{{asset('front/assets/image/catalog/demo/category/men-cat.jpg')}}"></a>
            </div>
          </div>
        </div>
									...
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a href="product.html" title="Computer Science saepe eveniet ut et volu redae ">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/23.jpg')}}" alt="Computer Science saepe eveniet ut et volu redae " title="Computer Science saepe eveniet ut et volu redae " class="img-1 img-responsive">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/15.jpg')}}" alt="Computer Science saepe eveniet ut et volu redae " title="Computer Science saepe eveniet ut et volu redae " class="img-2 img-responsive">
											</a>
											<div class="box-label">
												<span class="label-product label-sale">
													Sale
								...
								<div class="product-item-container">
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											...
											<img src="{{asset('front/assets/image/catalog/demo/product/electronic/22.jpg')}} " alt="Compact Portable Charger External " title="Compact Portable Charger External " class="img-1 img-responsive">
											<img src="{{asset('front/assets/image/catalog/demo/product/electronic/23.jpg')}}" alt="Compact Portable Charger External " title="Compact Portable Charger External " class="img-2 img-responsive">
											</a>
											<div class="box-label">
												<span class="label-product label-sale">
													Sale
									...
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a href="product.html" title="Compact Portable Charger (Power Bank) with Premium ">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/19.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium " title="Compact Portable Charger (Power Bank) with Premium " class="img-1 img-responsive">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/2.jpg')}}" alt="Compact Portable Charger (Power Bank) with Premium " title="Compact Portable Charger (Power Bank) with Premium " class="img-2 img-responsive">
											</a>
											<div class="box-label">
												<span class="label-product label-sale">
													Sale
									...
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a href="product.html" title="Compact Portable Charger (External Battery) T23 ">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/17.jpg')}} " alt="Compact Portable Charger (External Battery) T23 " title="Compact Portable Charger (External Battery) T23 " class="img-1 img-responsive">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/15.jpg')}}" alt="Compact Portable Charger (External Battery) T23 " title="Compact Portable Charger (External Battery) T23 " class="img-2 img-responsive">
											</a>
										</div>
									</div>
									<div class="box-label">
									...
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a href="product.html" title="Compact Portable Charger (External Battery) ">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/13.jpg')}}" alt="Compact Portable Charger (External Battery) " title="Compact Portable Charger (External Battery) " class="img-1 img-responsive">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/15.jpg')}}" alt="Compact Portable Charger (External Battery) " title="Compact Portable Charger (External Battery) " class="img-2 img-responsive">
											</a>
											<div class="box-label">
											</div> 
										</div>
									...
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a href="product.html" title="Compact (External Battery Power Bank) with Premium ">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/12.jpg')}}" alt="Compact (External Battery Power Bank) with Premium " title="Compact (External Battery Power Bank) with Premium " class="img-1 img-responsive">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/2.jpg')}}" alt="Compact (External Battery Power Bank) with Premium " title="Compact (External Battery Power Bank) with Premium " class="img-2 img-responsive">
											</a>
										</div>
									</div>
									<div class="right-block">
									...
									<div class="left-block">
										<div class="product-image-container  second_img  ">
											<a href="product.html" title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus ">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/1.jpg')}} " alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " class="img-1 img-responsive">
												<img src="{{asset('front/assets/image/catalog/demo/product/electronic/10.jpg')}}" alt=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " title=" Magnetic Air Vent Phone Holder for iPhone 7 / 7 Plus " class="img-2 img-responsive">
											</a>
										</div>
										<div class="countdown_box">
											<div class="countdown_inner">
                  ...
                  <div class="left-block">
                    <div class="product-image-container  second_img  ">
                      <a href="product.html" title="Portable  Compact Charger (External Battery) t45">
                        ...
                        <img src="{{asset('front/assets/image/catalog/demo/product/electronic/6.jpg')}}" alt="Portable  Compact Charger (External Battery) t45" title="Portable  Compact Charger (External Battery) t45" class="img-2 img-responsive">
                      </a>
                    </div>
                    <div class="box-label">
