						...
						<tbody>
							<tr>
								<td class="text-center">
									<a href="product.html"><img width="85" class="img-thumbnail" title="Aspire Ultrabook Laptop" alt="Aspire Ultrabook Laptop" src="{{asset('front/assets/image/catalog/demo/product/fashion/1.jpg')}}">
									</a>
								</td>
							...
							<tr>
								<td class="text-center">
									<a href="product.html"><img  width="85" class="img-thumbnail" title="Xitefun Causal Wear Fancy Shoes" alt="Xitefun Causal Wear Fancy Shoes" src="{{asset('front/assets/image/catalog/demo/product/fashion/4.jpg')}}">
									</a>
								</td>
