	                    ...
	                    <tbody>
	                        <tr>
	                            <td class="text-center" style="width:60px; height:60px"> 
	                                <a href="product.html"><img src="{{asset('front/assets/image/catalog/demo/product/spa/9.jpg')}}" alt="Burger King Japan debuts Monster  Baby Force Bralette" title="Burger King Japan debuts Monster  Baby Force Bralette" class="img-thumbnail"></a>
	                            </td>
	                        ...
	                        <tr>
	                            ...
	                            <td class="text-right">
	                                ...
	                                <a href="#" data-toggle="tooltip" title="" class="btn btn-danger" data-original-title="Remove"><i class="fa fa-times"></i></a>
                                </td>
	                        </tr>
	                    </tbody>
